...
func (m *OperatorMutation) SetHashedPassword(s string) {
	m._HashedPassword = &s
}

// HashedPassword returns the value of the "HashedPassword" field in the mutation.
func (m *OperatorMutation) HashedPassword() (r string, exists bool) {
	v := m._HashedPassword
	if v == nil {
		return
	}
...
// OldHashedPassword returns the old "HashedPassword" field's value of the Operator entity.
// If the Operator object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *OperatorMutation) OldHashedPassword(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *OperatorMutation) ResetHashedPassword() {
	m._HashedPassword = nil
}

// SetRole sets the "Role" field.
func (m *OperatorMutation) SetRole(s string) {
	m._Role = &s
}

// Role returns the value of the "Role" field in the mutation.
func (m *OperatorMutation) Role() (r string, exists bool) {
	v := m._Role
	if v == nil {
		return
	}
...
// OldRole returns the old "Role" field's value of the Operator entity.
// If the Operator object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *OperatorMutation) OldRole(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *OperatorMutation) ResetRole() {
	m._Role = nil
}
...
func (m *OperatorMutation) Fields() []string {
	...
	if m._HashedPassword != nil {
		fields = append(fields, operator.FieldHashedPassword)
	}
	if m._Role != nil {
		fields = append(fields, operator.FieldRole)
	}
	return fields
}
